...
contract ExpenseTracker {
    ...
    function getMyName() public view returns (string memory) {
        ...
        require(bytes(name).length > 0, "Name not registered");
        return name;
    }
    ...
    function getNameByAddress(address user)
        public
        view
    ...
    /**
 * @dev Checks if a given address is registered in the system
...
function isUserRegistered(address _walletAddress) public view returns (bool) {
    return people[_walletAddress].walletAddress != address(0);
}
...
function updatePersonName(string memory _newName) public {
     ...
     */
    function getPerson(address _addr)
        public
        view
        returns (string memory name, address walletAddress)
    {
     ...
     */
    function getExpenseParticipants(uint256 _expenseId)
        public
        view
     ...
     */
    function getExpenseBasicInfo(uint256 _expenseId)
        public
        view
        returns (
            uint256,
    ...
    function getAmountPaid(uint256 _expenseId, address _participant)
        public
        view
        returns (uint256)
    {
    ...
    function getAmountOwed(uint256 _expenseId, address _participant)
        public
        view
        returns (uint256)
    {
